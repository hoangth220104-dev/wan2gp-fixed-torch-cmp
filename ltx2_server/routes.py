...
async def generate_video_endpoint(
    ...
    input_video: Optional[UploadFile] = File(None, description="Input source video to continue from"),
    video_prompt_type: str = Form("", description="Advanced model control flags. For this server, source-video continuation comes from input_video; G enables denoising-strength control."),
